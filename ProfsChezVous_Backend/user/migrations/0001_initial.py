    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ville', models.CharField(max_length=100)),
                ('numero_telephone', models.CharField(max_length=12)),
                ('cv', models.FileField(upload_to=user.models.cv_file_name)),
                ('diplome', models.FileField(upload_to=user.models.diplome_file_name)),
                ('date_naissance', models.DateField()),
                ('niveau_etude', models.CharField(max_length=50)),
                ('latitude', models.FloatField()),
                ('longitude', models.FloatField()),
                ('adresse', models.CharField(blank=True, max_length=255, null=True)),
                ('matieres_a_enseigner', models.ManyToManyField(to='api.matiere')),
