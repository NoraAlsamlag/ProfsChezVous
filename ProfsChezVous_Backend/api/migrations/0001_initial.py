    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.CharField(choices=[('EC', 'En cours'), ('AV', 'A venir'), ('T', 'Terminer'), ('A', 'Annulé')], default='AV', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='commentaires_user', to=settings.AUTH_USER_MODEL)),
                ('cour', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.cour')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cours_manque', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.cour')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('heure_fine', models.TimeField(null=True)),
                ...
                ('et_payer', models.BooleanField(blank=True, default=False, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_transaction', models.CharField(blank=True, max_length=100, null=True)),
                ('montant_prof', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('montant_admin', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('date_creation', models.DateTimeField(auto_now_add=True, null=True)),
                ('statut', models.CharField(blank=True, choices=[('pending', 'Pending'), ('success', 'Success'), ('failed', 'Failed')], max_length=20, null=True)),
                ('object_id', models.PositiveIntegerField(blank=True, null=True)),
                ('content_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
                ('professeur', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='transactions_prof', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
