...
const ipAddress = 'http://192.168.6.85:8000';
...
final RegExp nomPrenomValidatorRegExp =
    RegExp(r"^[a-zA-Z]+(([',. -][a-zA-Z ])?[a-zA-Z]*)*$");

const String kNumeroTelephoneCommencerPar234 =
    "Le numéro de téléphone doit commencer par 2, 3 ou 4";
...
const String kDateNaissanceNullError =
    "Veuillez entrer votre date de naissance";
const String kEtablissementNullError =
    "Veuillez entrer le nom de l'établissement";
const String kEmailDejaUtiliseError = "Cet email est déjà utilisé";
const String kNumeroTelephoneContientLetterError =
    "Le numéro de téléphone ne doit contenir que des chiffres";
const String kNumeroTelephoneLengthError =
    "Le numéro de téléphone ne doit pas dépasser 8 chiffres";
